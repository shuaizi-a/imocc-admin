  ...
  <div class="trend-data-container">
    ...
    <div class="item">
      ...
      <div class="item-amount">
        <span ref="tadayAddedTarget" class="item-amount-number">{{ data.tadayAdded }}</span>
        {{ $t('msg.chart.unit') }}
      </div>
    </div>
    <!-- 今日支出 -->
    <div class="item">
      ...
      <div class="item-amount">
        <span ref="tadayExpendTarget" class="item-amount-number">{{ data.tadaySub }}</span>
        {{ $t('msg.chart.unit') }}
      </div>
    </div>
    <!-- 今日结余 -->
    <div class="item">
      ...
      <div class="item-amount">
        <span ref="tadayBalanceTarget" class="item-amount-number">{{ data.tadayAmount }}</span>
        {{ $t('msg.chart.unit') }}
      </div>
    </div>
  </div>
